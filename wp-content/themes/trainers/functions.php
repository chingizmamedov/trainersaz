...
if ( ! function_exists( 'trainers_setup' ) ) :
	/**
	 ...
	 */
	function trainers_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on trainers, use a find and replace
		 * to change 'trainers' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'trainers', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'trainers' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'trainers_custom_background_args', array(
...
add_action( 'after_setup_theme', 'trainers_setup' );
 ...
 */
function trainers_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'trainers_content_width', 640 );
}
add_action( 'after_setup_theme', 'trainers_content_width', 0 );
 ...
 */
function trainers_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'trainers' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'trainers' ),
...
add_action( 'widgets_init', 'trainers_widgets_init' );
...
function trainers_scripts() {
	...
	wp_enqueue_script( 'trainers-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'trainers-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
